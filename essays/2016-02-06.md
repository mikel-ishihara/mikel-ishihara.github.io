...
One really useful trick I learned from the ES6 module in projecturl:https://www.freecodecamp.org/ was the ternary operator. For example, the following function determines if a number is odd.
